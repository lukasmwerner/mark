...
Available Commands:
  ...
  createEmbeddings Generates vector embeddings that are not currently in the embeddings table
  ...
  search           [EXPERIMENTAL] google search like interface
  server           Local HTTP server for managing bookmarks
